...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('ProtonMonteCarloProduction/Configuration/POMWIG_SingleDiffractiveMinusZee_M20_13TeV_cff.py nevts:1476'),
